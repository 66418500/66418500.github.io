...
def main():
    ...
    #I use the first argument to determine whether the command executed successfully and get the value of the second return argument as the content variable.
    if content[0]!=0: 
    ...
    if content[0]==0:
        ...
        try:
            ...
            with open('content/post/{0}.md'.format(title), 'r+') as f: 
                file=f.read()
